...
import './about.css'
import aboutImg from './img/im3.JPG';
    ...
    return (
        ...
        <div className='container'>
            ...
            <div className='col__2'>
                    <img src={aboutImg} alt="" height="400px" className="about__img"/>
            </div>
                <div className='col__2'>
                    ...
                    <p className='about__text p__color'>
                      I am a passionate fullstack developer and entrepreneur  with over 5 years experience in the software engineering.My area of expertise are fullstack development and mobile app development.
                        ...
                        <a href='/cv/portfoliocv.pdf' target="_blank" download><button className='about btn pointer'>Download CV</button></a>
